...
if __name__ == '__main__':
    ...
    get_tf_idf('data/20news-bydate/20news-full-processed.txt', 'data/20news-bydate/tf-idf_full.txt')
    get_tf_idf('data/20news-bydate/20news-train-processed.txt', 'data/20news-bydate/tf-idf_train.txt')
    get_tf_idf('data/20news-bydate/20news-test-processed.txt', 'data/20news-bydate/tf-idf_test.txt')
